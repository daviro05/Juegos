    ...
    */
    Sudoku.prototype.drawBoard = function(){
        ...
        var sudoku_statistics = $('<div></div>')
                                    .addClass('statistics')
        .html('<span class="blanco">Celdas:  </span><span class="cells_complete">'+ this.cellsComplete +'/'+this.cellsNr +'</span> <span class="blanco">  Tiempo:  </span> <span class="time">' + this.secondsElapsed + '</span>');

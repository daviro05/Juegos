var drawingApp = (function () {
	...
	"use strict";
	var imagenes = ["images/dibujo1.png", "images/dibujo2.png"];
	...
	var canvas,
		...
		colorCarne = "#e1b99c",
		colorVerde = "#a0c470",
		colorAzulClaro = "#5ecbd9",
		colorAzulOscuro = "#314b65",
		colorGranate = "#551c34",
		colorRosa = "#d97384",
		colorNegro = "#0f0404",
		colorClaro = "#e0eaea",
		...
		redraw = function () {
			...
			if (curTool === "crayon") {
				...
				// Draw carne crayon
				selected = (curColor === colorCarne);
				locX = selected ? 18 : 52;
				locY = 19;
				drawCrayon(locX, locY, colorCarne, selected);

				// Draw verde crayon
				selected = (curColor === colorVerde);
				locX = selected ? 18 : 52;
				locY += 46;
				drawCrayon(locX, locY, colorVerde, selected);

				// Draw azul claro crayon
				selected = (curColor === colorAzulClaro);
				locX = selected ? 18 : 52;
				locY += 46;
				drawCrayon(locX, locY, colorAzulClaro, selected);

				// Draw azul oscuro crayon
				selected = (curColor === colorAzulOscuro);
				locX = selected ? 18 : 52;
				locY += 46;
				drawCrayon(locX, locY, colorAzulOscuro, selected);

				// Draw marron crayon
				selected = (curColor === colorGranate);
				locX = selected ? 18 : 52;
				locY += 46;
				drawCrayon(locX, locY, colorGranate, selected);

				// Draw rosa crayon
				selected = (curColor === colorRosa);
				locX = selected ? 18 : 52;
				locY += 46;
				drawCrayon(locX, locY, colorRosa, selected);

				// Draw negro crayon
				selected = (curColor === colorNegro);
				locX = selected ? 18 : 52;
				locY += 46;
				drawCrayon(locX, locY, colorNegro, selected);

				// Draw claro crayon
				selected = (curColor === colorClaro);
				locX = selected ? 18 : 52;
				locY += 40;
				drawCrayon(locX, locY, colorClaro, selected);
				...
				locX = selected ? 18 : 52;
				locY = 19;
				drawMarker(locX, locY, colorCarne, selected);

				// Draw green marker
				selected = (curColor === colorVerde);
				locX = selected ? 18 : 52;
				locY += 46;
				drawMarker(locX, locY, colorVerde, selected);

				// Draw yellow marker
				selected = (curColor === colorAzulClaro);
				locX = selected ? 18 : 52;
				locY += 46;
				drawMarker(locX, locY, colorAzulClaro, selected);

				// Draw azul oscuro crayon
				selected = (curColor === colorAzulOscuro);
				locX = selected ? 18 : 52;
				locY += 46;
				drawMarker(locX, locY, colorAzulOscuro, selected);

				// Draw brown marker
				selected = (curColor === colorGranate);
				locX = selected ? 18 : 52;
				locY += 46;
				drawMarker(locX, locY, colorGranate, selected);

				// Draw rosa crayon
				selected = (curColor === colorRosa);
				locX = selected ? 18 : 52;
				locY += 46;
				drawMarker(locX, locY, colorRosa, selected);

				// Draw negro crayon
				selected = (curColor === colorNegro);
				locX = selected ? 18 : 52;
				locY += 46;
				drawMarker(locX, locY, colorNegro, selected);

				// Draw claro crayon
				selected = (curColor === colorClaro);
				locX = selected ? 18 : 52;
				locY += 40;
				drawMarker(locX, locY, colorClaro, selected);
...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
		...
		init = function () {
			...
			crayonBackgroundImage.src = "images/d-crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "images/d-marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "images/d-eraser-background.png";

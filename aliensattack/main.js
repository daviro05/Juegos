...
var nave = {
	x:canvas.width/2-70,
	y:canvas.height-100, //Para que se situe abajo de nuestro cuadro canvas
	width:90,
	height:90,
	contador:0
}
...
var preloader;
var img_avatar = "imagenes/avatares/1.png";
...
function actualizarEstadoJuego(){
	...
	if(juego.estado == 'esperando'){
		textoRespuesta.titulo = 'Aliens Attack';
		textoRespuesta.subtitulo = 'Pulsa ENTER para comenzar el juego';
